...
openweather_base_url = 'http://api.openweathermap.org/data/2.5/onecall?' 
openweather_URL = openweather_base_url + 'lat=' + lat + '&lon=' + long + '&units=' + units +'&appid=' + openweather_api_key

# function to use 511org API to find next arrivals
#   at each of the provided stopcodes
# current configuration is hardcoded to the 'SF' operator, which is MUNI
# to extend configurability will need to use [stopcode, operator] pairings 
#   for each stop desired
